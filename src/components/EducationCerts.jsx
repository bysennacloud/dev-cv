const education = [
  { title: "MBA Lato Sensu — Desenvolvimento de Softwares", org: "UNIFACS (EAD)", period: "2024" },
  { title: "Redes de Computadores — Graduação", org: "UNIRUY", period: "2018–2020" },
  ...
  <div className="grid gap-4 sm:gap-5 md:gap-6 md:grid-cols-2">
      ...
      <div className="edu-card edu-featured edu-glow group">
        ...
        <ul className="edu-list">
          {education.map((e) => (
            <li key={e.title} className="edu-item p-3 sm:p-4 rounded-lg sm:rounded-xl">
